...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    apt-get update
    apt-get install -y build-essential mininet iproute2 iputils-ping net-tools tcpdump gdb strace emacs-nox vim git golang-go xterm x11-xserver-utils xauth
